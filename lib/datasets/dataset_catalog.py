...
DATASETS = {
    ...
    'maze_train': {
        IM_DIR:
            _DATA_DIR + '/maze/images/train',
        ANN_FN:
            _DATA_DIR + '/maze/annotations/maze_ods.json'
    },
    'apollo_train': {
        IM_DIR:
            _DATA_DIR + '/apollo/images/train',
        ANN_FN:
            _DATA_DIR + '/apollo/annotations/apollo_ods.json'
    },
    'apollo_laneseg_train': {
        IM_DIR:
            _DATA_DIR + '/apollo_laneseg/images/train',
        ANN_FN:
            _DATA_DIR + '/apollo_laneseg/annotations/apollo_laneseg.json'
    },
    'coco_2014_train': {
        IM_DIR:
